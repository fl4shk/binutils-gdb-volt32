...
target_alias=volt32-none-elf
target_vendor=none
target_os=elf
target=volt32-none-elf

program_transform_name = s&^&volt32-none-elf-&

prefix = /home/fl4shk/local
exec_prefix = ${prefix}
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --target=volt32-none-elf --prefix=/home/fl4shk/local

tooldir = ${exec_prefix}/volt32-none-elf
build_tooldir = ${exec_prefix}/volt32-none-elf
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/home/fl4shk/local' --program-transform-name='s&^&volt32-none-elf-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  intl libiberty opcodes bfd readline zlib libbacktrace libdecnumber libctf gprof etc
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  '--prefix=/home/fl4shk/local' --program-transform-name='s&^&volt32-none-elf-&' --disable-option-checking
...
TARGET_SUBDIR = volt32-none-elf
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib --with-cross-host=x86_64-pc-linux-gnu   '--prefix=/home/fl4shk/local' --program-transform-name='s&^&volt32-none-elf-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AS = as
AR = ar --plugin /usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/liblto_plugin.so
AR_FLAGS = rc
CC = gcc
CXX = g++
DLLTOOL = dlltool
...
OBJDUMP = objdump
OTOOL = @OTOOL@
RANLIB = ranlib --plugin /usr/lib/gcc/x86_64-pc-linux-gnu/12.1.0/liblto_plugin.so
READELF = readelf
STRIP = strip
WINDRES = windres
WINDMC = windmc
...
AR_FOR_TARGET=volt32-none-elf-ar
AS_FOR_TARGET=volt32-none-elf-as
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) volt32-none-elf-cc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) volt32-none-elf-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) volt32-none-elf-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) volt32-none-elf-c++
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) volt32-none-elf-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) volt32-none-elf-gccgo
GDC_FOR_TARGET=$(STAGE_CC_WRAPPER) @GDC_FOR_TARGET@
DLLTOOL_FOR_TARGET=volt32-none-elf-dlltool
DSYMUTIL_FOR_TARGET=@DSYMUTIL_FOR_TARGET@
LD_FOR_TARGET=volt32-none-elf-ld

LIPO_FOR_TARGET=volt32-none-elf-lipo
NM_FOR_TARGET=volt32-none-elf-nm
OBJDUMP_FOR_TARGET=volt32-none-elf-objdump
OBJCOPY_FOR_TARGET=volt32-none-elf-objcopy
OTOOL_FOR_TARGET=@OTOOL_FOR_TARGET@
RANLIB_FOR_TARGET=volt32-none-elf-ranlib
READELF_FOR_TARGET=volt32-none-elf-readelf
STRIP_FOR_TARGET=volt32-none-elf-strip
WINDRES_FOR_TARGET=volt32-none-elf-windres
WINDMC_FOR_TARGET=volt32-none-elf-windmc
